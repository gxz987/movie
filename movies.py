...
from PyQt5.QtWidgets import QLabel, QPushButton, QLineEdit, QListWidget, QGridLayout, QComboBox, QMessageBox, \
    QApplication, QAction, QMainWindow, QWidget, QVBoxLayout
